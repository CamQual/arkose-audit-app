...
if not st.session_state['logged_in']:
    css_login = "<style>[data-testid='stForm'] { background-color: rgba(132, 27, 243, 0.75) !important; padding: 40px !important; border-radius: 15px !important; border: 2px solid #841bf3 !important; margin-top: 50px; } .stButton>button { width: 100%; background-color: #841bf3 !important; color: white; border-radius: 8px;}</style>"
...
css_main = "<style>.block-container { background-color: rgba(132, 27, 243, 0.75) !important; padding: 40px !important; border-radius: 15px !important; border: 2px solid #841bf3 !important; margin-top: 20px !important; margin-bottom: 20px !important; }</style>"
